      ...
      <div className="flex flex-col items-center justify-center sm:w-1/2 p-8 pb-20 gap-16 sm:p-20 bg-black">
        <main className="flex flex-col gap-8 items-center sm:items-start">
          ...
          <div className="flex gap-4 items-center flex-col sm:flex-row">
            <a
              className="rounded-full border border-solid border-transparent transition-colors flex items-center justify-center bg-gray-700 text-background gap-2 hover:bg-[#383838] dark:hover:bg-[#ccc] text-sm sm:text-base h-10 sm:h-12 px-4 sm:px-5"
              href="/login"
              target="_blank"
            ...
            <a
              className="rounded-full border border-black/[.08] dark:border-white/[.145] transition-colors flex items-center justify-center hover:bg-[#383838] dark:hover:bg-[#383838] hover:border-transparent text-sm sm:text-base h-10 sm:h-12 px-4 sm:px-5 sm:min-w-44 outline outline-white"
              href="/register"
              target="_blank"
              rel="noopener noreferrer"
            >
